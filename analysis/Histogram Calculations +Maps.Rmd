...
map <- ggmap(google_map) +
  ...
  geom_sf(data = bsec_stations, aes(color = "BSEC"), size = 3, shape = 21, fill = "red", inherit.aes = FALSE) +
  geom_sf(data = private_stations, aes(color = "Private"), size = 3, shape = 21, fill = "black", inherit.aes = FALSE) +
  scale_color_manual(
  ...
  labs(
    title = "Percentage of Black Population in Baltimore Census Tracts",
    subtitle = "Weather Stations (BSEC: Red, Private: Black) and Streets Overlaid",
